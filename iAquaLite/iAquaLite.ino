...
MenuItem miM1 = MenuItem("WRGB M1 DWN/DSK");
MenuItem miM2 = MenuItem("WRGB M2 RIS/SET");

// fade menu for fade schedules
MenuItem miF1 = MenuItem("MOON > M1 DAWN");
MenuItem miF2 = MenuItem("M1 DWN > M2 RSE");
MenuItem miF3 = MenuItem("M2 RISE > DAY");
MenuItem miF4 = MenuItem("DAY > M2 SET");
MenuItem miF5 = MenuItem("M2 SET > M1 DSK");
MenuItem miF6 = MenuItem("M1 DUSK > MOON");
  ...
  case BUTTON_SELECT:
    {
      ...
      // SAVE RAMP SCHEDULES
      if (menu.getCurrent().getName() == "MOON > M1 DAWN") updateFade1();
      if (menu.getCurrent().getName() == "M1 DWN > M2 RSE") updateFade2();
      if (menu.getCurrent().getName() == "M2 RISE > DAY") updateFade3();
      if (menu.getCurrent().getName() == "DAY > M2 SET") updateFade4();
      if (menu.getCurrent().getName() == "M2 SET > M1 DSK") updateFade5();
      if (menu.getCurrent().getName() == "M1 DUSK > MOON") updateFade6();
...
void drawScreen()
{
  ...
  if (menu.getCurrent().getName() == "HOME") {
    ...
    if (currentLightMode == 5) fprintf_P(&lcdout, PSTR("LIGHT OFF"));
      ...
      // as a reference point, check to see if we are before or after the fade into daylight
      time_t fade3Start = tmConvert_t(year(),month(),day(),fade3.onHour,fade3.onMinute,0); // get a unix time stamp for the fade start
      if (fade3Start > currentTime) fprintf_P(&lcdout, PSTR("DAWN M1"));
      else fprintf_P(&lcdout, PSTR("DUSK M1"));
    }
  ...
  else if (menu.getCurrent().getName() == "WRGB M1 DWN/DSK") {
  ...
  else if (menu.getCurrent().getName() == "MOON > M1 DAWN") {
  ...
  else if (menu.getCurrent().getName() == "M1 DWN > M2 RSE") {
  ...
  else if (menu.getCurrent().getName() == "M2 SET > M1 DSK") {
  ...
  else if (menu.getCurrent().getName() == "M1 DUSK > MOON") {
...
void editButtons(byte buttons)
{
  byte x;
  byte y;
  switch( buttons ) // neeed to respond differently to each button
  {
  case BUTTON_UP:
    {
...
void loadLightWRGB() 
{
  ...
  if ((lightDaylight.Red <= 100) && (lightDaylight.Red >= 0)) ;
  else {
    lightDaylight.Red=0;
    EEPROM.write(200,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightDaylight.Green <= 100) && (lightDaylight.Green >= 0))  ;
  else {
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightDaylight.Blue <= 100) && (lightDaylight.Blue >= 0))  ;
  else {
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightDaylight.White <= 100) && (lightDaylight.White >= 0))  ;
  else {
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightM2.Red <= 100) && (lightM2.Red >= 0))  ;
  else {
    lightM2.Red=0;
    EEPROM.write(204,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightM2.Green <= 100) && (lightM2.Green >= 0))  ;
  else {
    lightM2.Green=0;
    EEPROM.write(205,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightM2.Blue <= 100) && (lightM2.Blue >= 0))  ;
  else {
    lightM2.Blue=0;
    EEPROM.write(206,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightM2.White <= 100) && (lightM2.White >= 0))  ;
  else {
    lightM2.White=0;
    EEPROM.write(207,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightM1.Red <= 100) && (lightM1.Red >= 0))  ;
  else {
    lightM1.Red=0;
    EEPROM.write(208,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightM1.Green <= 100) && (lightM1.Green >= 0))  ;
  else {
    lightM1.Green=0;
    EEPROM.write(209,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightM1.Blue <= 100) && (lightM1.Blue >= 0))  ;
  else {
    lightM1.Blue=0;
    EEPROM.write(210,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightM1.White <= 100) && (lightM1.White >= 0))  ;
  else {
    lightM1.White=0;
    EEPROM.write(211,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightMoon.Red <= 100) && (lightMoon.Red >= 0))  ;
  else {
    lightMoon.Red=0;
    EEPROM.write(212,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightMoon.Green <= 100) && (lightMoon.Green >= 0))  ;
  else {
    lightMoon.Green=0;
    EEPROM.write(213,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightMoon.Blue <= 100) && (lightMoon.Blue >= 0))  ;
  else {
    lightMoon.Blue=0;
    EEPROM.write(214,0);
  }
  ...
  // if the value is out of range, set it to 0 and re-save it
  if ((lightMoon.White <= 100) && (lightMoon.White >= 0))  ;
  else {
    lightMoon.White=0;
    EEPROM.write(215,0);
  }
